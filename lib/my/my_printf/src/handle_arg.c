...
#include "./handle_args/precision.h"
#include "./type/char.h"
...
{
    {type_unint, type_unint, type_unint, type_unint, type_unint, type_unint,
        type_unint, type_unint},
...
static int (*func_ptr_int[][8])(va_list, t_local_spe) =
{
    ...
    {type_unint, type_unchar, type_unshort, type_unlong, type_unllong,
        type_uintmax_t, type_sizet, type_unptrdiff_t}
};*/
