...
int     main()
{
  ...
  */
  ...
  /* Pourquoi les my_printf de my_printf ? Parce que printf renvoie le nombre de caractere qu'il a affiche. Ainsi, on peut verifier si on renvoie bien le bon nombre.
     Attention ! Il doit y avoir un caractere de moins sur le my_printf puisqu'il n'a qu'un \n, pour plus de lisibilite */

  printf("%d\n\n", my_printf("%d\n\n", printf("%d\n", 2147483647)));

  /* Verifiez bien les bornes ! Elles ont tendance a boucler infini ... */

  my_printf("%d\n", my_printf("Les bornes :  %d, %d\n", -2147483648, 2147483647));
  my_printf("%d\n", my_printf("Les bornes :  %u, %u\n", 0, 4294967295));
  my_printf("%d\n", my_printf("Les bornes :  %o, %o\n", 0, 4294967295));
  my_printf("%d\n", my_printf("Les bornes :  %x, %x\n", 0, 4294967295));
  ...
  */
  ...
  /*
  my_printf("%d\n", my_printf("1hexa 1 %x hexa 2 %x\n", 42, -42));
  printf("%d\n\n", printf("1hexa 1 %x hexa 2 %x\n\n", 42, -42));

  my_printf("%d\n", my_printf("2hexa 1 %   x hexa 2 % x\n", 42, -42));
  printf("%d\n\n", printf("3hexa 1 %   x hexa 2 % x\n\n", 42, -42));

  my_printf("%d\n", my_printf("4hexa 1 %12x hexa 2 %12x\n", 42, -42));
  printf("%d\n\n", printf("4hexa 1 %12x hexa 2 %12x\n\n", 42, -42));

  my_printf("%d\n", my_printf("4hexa 1 %-12x hexa 2 %-12x\n", 42, -42));
  printf("%d\n\n", printf("4hexa 1 %-12x hexa 2 %-12x\n\n", 42, -42));

  my_printf("%d\n", my_printf("5hexa 1 %0x hexa 2 %0x\n", 42, -42));
  printf("%d\n\n", printf("5hexa 1 %0x hexa 2 %0x\n\n", 42, -42));

  my_printf("%d\n", my_printf("6hexa 1 %012x hexa 2 %012x\n", 42, -42));
  printf("%d\n\n", printf("6hexa 1 %012x hexa 2 %012x\n\n", 42, -42));

  my_printf("%d\n", my_printf("7hexa 1 %-012x hexa 2 %012x\n", 42, -42));
  printf("%d\n\n", printf("7hexa 1 %-012x hexa 2 %012x\n\n", 42, -42));

  my_printf("%d\n", my_printf("8hexa 1 %*x hexa 2 %*x\n", 42, 6, 6, 6));
  printf("%d\n\n", printf("8hexa 1 %*x hexa 2 %*x\n\n", 42, 6, 6, 6));

  my_printf("%d\n", my_printf("9hexa 1 %+x hexa 2 %+x\n", 42, 6, -42, 6));
  printf("%d\n\n", printf("9hexa 1 %+x hexa 2 %+x\n\n", 42, 6, -42, 6));

  my_printf("%d\n", my_printf("10hexa 1 %+12x hexa 2 %+12x\n", 42, 6, -42, 6));
  printf("%d\n\n", printf("10hexa 1 %+12x hexa 2 %+12x\n\n", 42, 6, -42, 6));

  my_printf("%d\n", my_printf("11hexa 1 %*12x hexa 2 %*12x\n", 42, -6, -42, 6));
  printf("%d\n\n", printf("11hexa 1 %*12x hexa 2 %*12x\n\n", 42, -6, -42, 6));

  my_printf("%d\n", my_printf("12hexa 1 %-+5x hexa 2 %-+5x\n", 42, -42));
  printf("%d\n\n", printf("12hexa 1 %-+5x hexa 2 %-+5x\n\n", 42, -42));

  my_printf("%d\n", my_printf("13hexa 1 %-+05x hexa 2 %-+05x\n", 42, -42));
  printf("%d\n\n", printf("13hexa 1 %-+05x hexa 2 %-+05x\n\n", 42, -42));

  my_printf("%d\n", my_printf("14hexa 1 %+-5x hexa 2 %+-5x\n", 42, -42));
  printf("%d\n\n", printf("14hexa 1 %+-5x hexa 2 %+-5x\n\n", 42, -42));

  my_printf("%d\n", my_printf("15hexa 1 %.x hexa 2 %.x\n", 42, -42));
  printf("%d\n\n", printf("15hexa 1 %.x hexa 2 %.x\n\n", 42, -42));

  my_printf("%d\n", my_printf("16hexa 1 %.6x hexa 2 %.6x\n", 42, -42));
  printf("%d\n\n", printf("16hexa 1 %.6x hexa 2 %.6x\n\n", 42, -42));
  */
  /* Memes tests avec les %X */
  /*
  my_printf("%d\n", my_printf("1hexa-maj 1 %X hexa-maj 2 %X\n", 42, -42));
  printf("%d\n\n", printf("1hexa-maj 1 %X hexa-maj 2 %X\n\n", 42, -42));

  my_printf("%d\n", my_printf("2hexa-maj 1 %   X hexa-maj 2 % X\n", 42, -42));
  printf("%d\n\n", printf("3hexa-maj 1 %   X hexa-maj 2 % X\n\n", 42, -42));

  my_printf("%d\n", my_printf("4hexa-maj 1 %12X hexa-maj 2 %12X\n", 42, -42));
  printf("%d\n\n", printf("4hexa-maj 1 %12X hexa-maj 2 %12X\n\n", 42, -42));

  my_printf("%d\n", my_printf("4hexa-maj 1 %-12X hexa-maj 2 %-12X\n", 42, -42));
  printf("%d\n\n", printf("4hexa-maj 1 %-12X hexa-maj 2 %-12X\n\n", 42, -42));

  my_printf("%d\n", my_printf("5hexa-maj 1 %0X hexa-maj 2 %0X\n", 42, -42));
  printf("%d\n\n", printf("5hexa-maj 1 %0X hexa-maj 2 %0X\n\n", 42, -42));

  my_printf("%d\n", my_printf("6hexa-maj 1 %012X hexa-maj 2 %012X\n", 42, -42));
  printf("%d\n\n", printf("6hexa-maj 1 %012X hexa-maj 2 %012X\n\n", 42, -42));

  my_printf("%d\n", my_printf("7hexa-maj 1 %-012X hexa-maj 2 %012X\n", 42, -42));
  printf("%d\n\n", printf("7hexa-maj 1 %-012X hexa-maj 2 %012X\n\n", 42, -42));

  my_printf("%d\n", my_printf("8hexa-maj 1 %*X hexa-maj 2 %*X\n", 42, 6, 6, 6));
  printf("%d\n\n", printf("8hexa-maj 1 %*X hexa-maj 2 %*X\n\n", 42, 6, 6, 6));

  my_printf("%d\n", my_printf("9hexa-maj 1 %+X hexa-maj 2 %+X\n", 42, 6, -42, 6));
  printf("%d\n\n", printf("9hexa-maj 1 %+X hexa-maj 2 %+X\n\n", 42, 6, -42, 6));

  my_printf("%d\n", my_printf("10hexa-maj 1 %+12X hexa-maj 2 %+12X\n", 42, 6, -42, 6));
  printf("%d\n\n", printf("10hexa-maj 1 %+12X hexa-maj 2 %+12X\n\n", 42, 6, -42, 6));

  my_printf("%d\n", my_printf("11hexa-maj 1 %*12X hexa-maj 2 %*12X\n", 42, -6, -42, 6));
  printf("%d\n\n", printf("11hexa-maj 1 %*12X hexa-maj 2 %*12X\n\n", 42, -6, -42, 6));

  my_printf("%d\n", my_printf("12hexa-maj 1 %-+5X hexa-maj 2 %-+5X\n", 42, -42));
  printf("%d\n\n", printf("12hexa-maj 1 %-+5X hexa-maj 2 %-+5X\n\n", 42, -42));

  my_printf("%d\n", my_printf("13hexa-maj 1 %-+05X hexa-maj 2 %-+05X\n", 42, -42));
  printf("%d\n\n", printf("13hexa-maj 1 %-+05X hexa-maj 2 %-+05X\n\n", 42, -42));

  my_printf("%d\n", my_printf("14hexa-maj 1 %+-5X hexa-maj 2 %+-5X\n", 42, -42));
  printf("%d\n\n", printf("14hexa-maj 1 %+-5X hexa-maj 2 %+-5X\n\n", 42, -42));

  my_printf("%d\n", my_printf("15hexa-maj 1 %.X hexa-maj 2 %.X\n", 42, -42));
  printf("%d\n\n", printf("15hexa-maj 1 %.X hexa-maj 2 %.X\n\n", 42, -42));

  my_printf("%d\n", my_printf("16hexa-maj 1 %.6X hexa-maj 2 %.6X\n", 42, -42));
  printf("%d\n\n", printf("16hexa-maj 1 %.6X hexa-maj 2 %.6X\n\n", 42, -42));
  */
  /* Memes tests avec les %p */
  /*
  my_printf("%d\n", my_printf("1pointeur 1 %p pointeur 2 %p\n", &c, &c));
  printf("%d\n\n", printf("1pointeur 1 %p pointeur 2 %p\n\n", &c, &c));

  my_printf("%d\n", my_printf("2pointeur 1 %   p pointeur 2 % p\n", &c, &c));
  printf("%d\n\n", printf("3pointeur 1 %   p pointeur 2 % p\n\n", &c, &c));

  my_printf("%d\n", my_printf("4pointeur 1 %12p pointeur 2 %12p\n", &c, &c));
  printf("%d\n\n", printf("4pointeur 1 %12p pointeur 2 %12p\n\n", &c, &c));

  my_printf("%d\n", my_printf("4pointeur 1 %-12p pointeur 2 %-12p\n", &c, &c));
  printf("%d\n\n", printf("4pointeur 1 %-12p pointeur 2 %-12p\n\n", &c, &c));

  my_printf("%d\n", my_printf("5pointeur 1 %0p pointeur 2 %0p\n", &c, &c));
  printf("%d\n\n", printf("5pointeur 1 %0p pointeur 2 %0p\n\n", &c, &c));

  my_printf("%d\n", my_printf("6pointeur 1 %012p pointeur 2 %012p\n", &c, &c));
  printf("%d\n\n", printf("6pointeur 1 %012p pointeur 2 %012p\n\n", &c, &c));

  my_printf("%d\n", my_printf("7pointeur 1 %-012p pointeur 2 %012p\n", &c, &c));
  printf("%d\n\n", printf("7pointeur 1 %-012p pointeur 2 %012p\n\n", &c, &c));
  */
  /* Ce test boucle infini avec le vrai printf */
  /*
  my_printf("%d\n", my_printf("8pointeur 1 %*p pointeur 2 %*p\n\n", &c, 6, &c, 6));

  my_printf("%d\n", my_printf("9pointeur 1 %+p pointeur 2 %+p\n", &c, 6, &c, 6));
  printf("%d\n\n", printf("9pointeur 1 %+p pointeur 2 %+p\n\n", &c, 6, &c, 6));

  my_printf("%d\n", my_printf("10pointeur 1 %+12p pointeur 2 %+12p\n", &c, 6, &c, 6));
  printf("%d\n\n", printf("10pointeur 1 %+12p pointeur 2 %+12p\n\n", &c, 6, &c, 6));

  my_printf("%d\n", my_printf("11pointeur 1 %*12p pointeur 2 %*12p\n", &c, -6, &c, 6));
  printf("%d\n\n", printf("11pointeur 1 %*12p pointeur 2 %*12p\n\n", &c, -6, &c, 6));

  my_printf("%d\n", my_printf("12pointeur 1 %-+5p pointeur 2 %-+5p\n", &c, &c));
  printf("%d\n\n", printf("12pointeur 1 %-+5p pointeur 2 %-+5p\n\n", &c, &c));

  my_printf("%d\n", my_printf("13pointeur 1 %-+05p pointeur 2 %-+05p\n", &c, &c));
  printf("%d\n\n", printf("13pointeur 1 %-+05p pointeur 2 %-+05p\n\n", &c, &c));

  my_printf("%d\n", my_printf("14pointeur 1 %+-5p pointeur 2 %+-5p\n", &c, &c));
  printf("%d\n\n", printf("14pointeur 1 %+-5p pointeur 2 %+-5p\n\n", &c, &c));

  my_printf("%d\n", my_printf("15pointeur 1 %.p pointeur 2 %.p\n", &c, &c));
  printf("%d\n\n", printf("15pointeur 1 %.p pointeur 2 %.p\n\n", &c, &c));

  my_printf("%d\n", my_printf("16pointeur 1 %.6p pointeur 2 %.6p\n", &c, &c));
  printf("%d\n\n", printf("16pointeur 1 %.6p pointeur 2 %.6p\n\n", &c, &c));
  */
  /* Memes tests avec les %u */
  /*
  my_printf("%d\n", my_printf("1unsigned 1 %u unsigned 2 %u\n", 42, -42));
  printf("%d\n\n", printf("1unsigned 1 %u unsigned 2 %u\n\n", 42, -42));

  my_printf("%d\n", my_printf("2unsigned 1 %   u unsigned 2 % u\n", 42, -42));
  printf("%d\n\n", printf("3unsigned 1 %   u unsigned 2 % u\n\n", 42, -42));

  my_printf("%d\n", my_printf("4unsigned 1 %12u unsigned 2 %12u\n", 42, -42));
  printf("%d\n\n", printf("4unsigned 1 %12u unsigned 2 %12u\n\n", 42, -42));

  my_printf("%d\n", my_printf("4unsigned 1 %-12u unsigned 2 %-12u\n", 42, -42));
  printf("%d\n\n", printf("4unsigned 1 %-12u unsigned 2 %-12u\n\n", 42, -42));

  my_printf("%d\n", my_printf("5unsigned 1 %0u unsigned 2 %0u\n", 42, -42));
  printf("%d\n\n", printf("5unsigned 1 %0u unsigned 2 %0u\n\n", 42, -42));

  my_printf("%d\n", my_printf("6unsigned 1 %012u unsigned 2 %012u\n", 42, -42));
  printf("%d\n\n", printf("6unsigned 1 %012u unsigned 2 %012u\n\n", 42, -42));

  my_printf("%d\n", my_printf("7unsigned 1 %-012u unsigned 2 %012u\n", 42, -42));
  printf("%d\n\n", printf("7unsigned 1 %-012u unsigned 2 %012u\n\n", 42, -42));

  my_printf("%d\n", my_printf("8unsigned 1 %*u unsigned 2 %*u\n", 42, 6, 6, 6));
  printf("%d\n\n", printf("8unsigned 1 %*u unsigned 2 %*u\n\n", 42, 6, 6, 6));

  my_printf("%d\n", my_printf("9unsigned 1 %+u unsigned 2 %+u\n", 42, 6, -42, 6));
  printf("%d\n\n", printf("9unsigned 1 %+u unsigned 2 %+u\n\n", 42, 6, -42, 6));

  my_printf("%d\n", my_printf("10unsigned 1 %+12u unsigned 2 %+12u\n", 42, 6, -42, 6));
  printf("%d\n\n", printf("10unsigned 1 %+12u unsigned 2 %+12u\n\n", 42, 6, -42, 6));

  my_printf("%d\n", my_printf("11unsigned 1 %*12u unsigned 2 %*12u\n", 42, -6, -42, 6));
  printf("%d\n\n", printf("11unsigned 1 %*12u unsigned 2 %*12u\n\n", 42, -6, -42, 6));

  my_printf("%d\n", my_printf("12unsigned 1 %-+5u unsigned 2 %-+5u\n", 42, -42));
  printf("%d\n\n", printf("12unsigned 1 %-+5u unsigned 2 %-+5u\n\n", 42, -42));

  my_printf("%d\n", my_printf("13unsigned 1 %-+05u unsigned 2 %-+05u\n", 42, -42));
  printf("%d\n\n", printf("13unsigned 1 %-+05u unsigned 2 %-+05u\n\n", 42, -42));

  my_printf("%d\n", my_printf("14unsigned 1 %+-5u unsigned 2 %+-5u\n", 42, -42));
  printf("%d\n\n", printf("14unsigned 1 %+-5u unsigned 2 %+-5u\n\n", 42, -42));

  my_printf("%d\n", my_printf("15unsigned 1 %.u unsigned 2 %.u\n", 42, -42));
  printf("%d\n\n", printf("15unsigned 1 %.u unsigned 2 %.u\n\n", 42, -42));

  my_printf("%d\n", my_printf("16unsigned 1 %.6u unsigned 2 %.6u\n", 42, -42));
  ...
  */
  ...
  my_printf("%d\n", my_printf("11signed 1 %*12i signed 2 %*12i signed 3 %*12i\n", 42, -6, -42, 6, 12, 6));
  printf("%d\n\n", printf("11signed 1 %*12i signed 2 %*12i signed 3 %*12i\n\n", 42, -6, -42, 6, 12, 6));

  my_printf("%d\n", my_printf("11unsigned 1 %*12u unsigned 2 %*12u unsigned 3 %*12u\n", 42, -6, -42, 6, 12, 6));
  ...
  */
  ...
  /*
  my_printf("J'affiche des %ncaracteres.", n);
...
/*
  ...
  */
  ...
  /*  my_printf("%d\n", my_printf("8string 1 %*s string 2 %*s\n", "toto", 6, "tata", 6));*/
  /*  printf("%d\n\n", printf("8string 1 %*s string 2 %*s\n\n", "toto", 6, "tata", 6));*/

  /*my_printf("%d\n", my_printf("9string 1 %+s string 2 %+s\n", "toto", 6, "bonjour", 6));*/
  /*printf("%d\n\n", printf("9string 1 %+s string 2 %+s\n\n", "toto", 6, "bonjour", 6));*/

  /*my_printf("%d\n", my_printf("10string 1 %+12s string 2 %+12s\n", "toto", 6, "bonjour", 6));*/
  /*  printf("%d\n\n", printf("10string 1 %+12s string 2 %+12s\n\n", "toto", 6, "bonjour", 6));*/

  /*my_printf("%d\n", my_printf("11string 1 %*12s string 2 %*12s\n", "toto", -6, "bonjour", 6));*/
